...
urlpatterns = [
    path('notifications/', views.getNotifs, name="notifications"),
    ...
    path('users/blocked/<str:username>/', views.getBlockedList, name="blocked-users"),
    ...
    path('get_conversations/<str:user_id>/', views.getConversations, name="get-conversations"),
    path('start_conversation/', views.startConversation, name="start-conversation"),
    path('delete_conversation/<str:conversation_id>/', views.deleteConversation, name="delete-conversation"),
    path('add_to_conversation/<str:conversation_id>/', views.addPersonToConversation, name="add-to-conversation"),
    path('get_messages/<str:conversation_id>/', views.getMessages, name="get-messages"),
    path('send_message/<str:conversation_id>/', views.sendMessage, name="send-message"),
    path('delete_message/<str:message_id>/', views.deleteMessage, name="delete-message"),
